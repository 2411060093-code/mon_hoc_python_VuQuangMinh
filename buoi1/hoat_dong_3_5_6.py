...
print ("xep loai gioi:", loai_gioi)
print ("xep loai kha:", loai_kha)
print ("xep loai trung binh:", loai_trung_binh)
print ("xep loai yeu:", loai_yeu)
print ("kieu du lieu cua loai_gioi:", type(loai_gioi))